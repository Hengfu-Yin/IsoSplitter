...
def CallSim4(qfile,seqfile,identity,length,processes,dirName):
	#Create a process pool
	pool = multiprocessing.Pool(processes)
	#Open the file you put in the command line.
	with open(qfile,'r') as seq_obj :
		r = seq_obj.readline()
...
def CommandLineArgs(thread):
	...
	parser.add_argument('qReadsFile',help="the transcripts sequence file in fasta format",type=lambda x: CheckSeqfile(parser,x))
...
def Main():
	...
	CallSim4(args.qReadsFile,args.longReadsFile,args.identity,length,args.thread,dirName)
